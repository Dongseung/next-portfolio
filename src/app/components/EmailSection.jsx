...
const EmailSection = () => {
    const handleSubmit = async (e) => {
        ...
        console.log(resData);
        if (resData.message) {
            console.log('Message sent (but actually disabled).');
        }
    };

    return (
        <section className="grid md:grid-cols-2 my-12 md:my-12 z-0 py-24 gap-4 relative" id="contact">
            ...
            <div>
                <form className="flex flex-col" onSubmit={handleSubmit}>
                    <div className="mb-6">
                        ...
                        <input name="email" type="email" id="email" required className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="example01@gmail.com" />
                    </div>
                    <div className="mb-6">
