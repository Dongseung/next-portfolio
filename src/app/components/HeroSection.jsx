      ...
      <div className="grid gird-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="mb-6 text-[#adb7be] text-base sm:text-lg lg:text-xl">
            ...
            neque cupiditate unde voluptate, quaerat deleniti magni perspiciatis
            recusandae explicabo illum omnis ullam distinctio suscipit id a
            possimus doloribus eveniet!
          </p>
          <div>
